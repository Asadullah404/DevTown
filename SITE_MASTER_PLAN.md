...
```mermaid
flowchart TD
    Hero["Hero Section<br>• 'Have an Idea? We'll Build It'<br>• Start Project CTA / See Demos"] --> Services["Services Grid<br>• 6 Core Solution Cards"]
    Services --> Demos["Portfolio Showcase<br>• 4 Live GitHub Demos with Modals"]
    Demos --> Process["How It Works<br>• 1. Tell Idea → 2. Get Quote → 3. We Build → 4. Handover"]
    Process --> Trust["Trust & Guarantees<br>• Fixed Pricing, Direct Dev Access, Post-Launch Support"]
    Trust --> Intake["Interactive Project Intake Wizard<br>• Multi-step dynamic quote questionnaire"]
    Intake --> Deliver["Lead Notification<br>• WhatsApp & Email notification to you"]
```
